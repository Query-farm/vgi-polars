...
"""Projection: correct result whether or not the resolved scan function
actually honors pushed `projection_ids` — Design Principle 1 (`_source.py`)
applies `.select(with_columns)` locally regardless."""
